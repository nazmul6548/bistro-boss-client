...
return res.data;
  ...
  <table className="min-w-full bg-white">
    <thead className="bg-gray-100 whitespace-nowrap">
      <tr>
        <th className="p-4 text-left text-xs font-semibold text-gray-800">Number</th>
        ...
        <th className="p-4 text-left text-xs font-semibold text-gray-800">Role</th>
    ...
    {
                users.map((item,index) =>(<tr key={item._id} className="hover:bg-gray-50">
